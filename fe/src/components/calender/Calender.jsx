                                            ...
                                            return (
                                                ...
                                                >
                                                    {item.subCategoryId === 503 ?
                                                        ...
                                                        :
                                                        <div className='shadow' style={{ fontSize: '15px', fontWeight: 'bold', backgroundColor: '#e8e6f4', borderRadius: '5px', padding: '0 0.4rem', margin: '0.1rem 0.1rem', backgroundColor: 'whitesmoke', border: '2px solid grey' }}>
                                                            {truncate(item.calenderName, 10)}
                                                        </div>
                                                    }
                                                </OverlayTrigger>

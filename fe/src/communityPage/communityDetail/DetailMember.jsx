...
`
const DetailMember = ({ isDark, detailData, commentDate, setCommentDate, projectData, totalCount, currentPage, setCurrentPage, setOpenChat, selectedUser, setSelectedUser, setTotalCount}) => {
